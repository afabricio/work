...
import br.com.kiman.kiprev.ki.xp.dominio.entity.pk.FolheteriaFundoPK;


/**
 * The persistent class for the INT_033_FOLHETERIA_FUNDO database table.
 * 
 */
@Entity
@Table(schema = "KPVCUST11", name="INT_033_FOLHETERIA_FUNDO")
@NamedQuery(name="FolheteriaFundo.findAll", query="SELECT i FROM FolheteriaFundo i")
public class FolheteriaFundo implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FolheteriaFundoPK id;
	...
	public FolheteriaFundo() {
	}

	public FolheteriaFundoPK getId() {
		return this.id;
	}

	public void setId(FolheteriaFundoPK id) {
		this.id = id;
	}
